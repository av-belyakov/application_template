...
// SetCountAnyValues некоторе количество значений
func (as *SharedAppStorage) SetCountAnyValues(v int) {
	as.statistics.countAnyValues.Store(int32(v))
}

// GetCountAnyValues некоторе количество значений
func (as *SharedAppStorage) GetCountAnyValues() int {
	return int(as.statistics.countAnyValues.Load())
}
...
func (as *SharedAppStorage) DeleteAll() {
	as.statistics.countAnyValues.Store(0)
